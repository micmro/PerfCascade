...
export function createRow(index: number, rectData: RectData,
  block: TimeBlock, labelXPos: number, leftFixedWidthPerc: number,
  docIsSsl: boolean, onDetailsOverlayShow: EventListener, onOverlayClose: EventListener): SVGGElement {
